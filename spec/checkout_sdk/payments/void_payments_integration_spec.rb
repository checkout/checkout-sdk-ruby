  ...
  describe '.void_payment' do
    context 'when attempt payment' do
      it 'void payment' do
        ...
        response = default_sdk.payments.void_payment(payment_response.id, request)
      ...
      it 'void payment idempotent' do
        ...
        proc = lambda { default_sdk.payments.void_payment(payment_response.id, request, idempotency_key) }
        proc2 = lambda { default_sdk.payments.void_payment(payment_response.id, request, idempotency_key) }
